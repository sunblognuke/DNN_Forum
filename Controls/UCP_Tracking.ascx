	...
	<table cellpadding="0" cellspacing="0" width="100%" class="Forum_SearchContainer">
		...
		<tr>
			<td class="Forum_UCP_HeaderInfo" align="left">
				<wrapper:RadTabStrip ID="rtsNotifications" runat="server" MultiPageID="rmpNotifications" SelectedIndex="0" Skin="Vista" AutoPostBack="true" />		
				<wrapper:RadMultiPage ID="rmpNotifications" runat="server" SelectedIndex="0">
